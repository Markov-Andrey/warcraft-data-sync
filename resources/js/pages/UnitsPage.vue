            ...
            <div class="overflow-x-auto rounded-lg border border-gray-700">
                <table class="w-full text-xs text-left border-collapse">
                    <thead class="bg-gray-800 text-yellow-300 uppercase sticky top-0 z-20">
                        <tr>
                            <th class="sticky left-0 z-20 bg-gray-800 px-2 py-1 border border-gray-700 border-r-yellow-600 w-16 min-w-[4rem] whitespace-nowrap">Unit</th>
                            <th class="sticky left-16 z-20 bg-gray-800 px-2 py-1 border border-gray-700 border-r-2 border-r-yellow-600 w-12 min-w-[3rem] text-center">Icon</th>
                            <th
                    ...
                    <tbody>
                        ...
                        >
                            <td class="sticky left-0 z-10 bg-gray-900 px-2 py-1 border border-gray-700/50 border-r-yellow-600 font-mono font-semibold text-yellow-200 whitespace-nowrap">
                                {{ unitCode }}
                            </td>
                            <td class="sticky left-16 z-10 bg-gray-900 px-1 py-1 border border-gray-700/50 border-r-2 border-r-yellow-600 text-center">
                                <img
